...
def model_nonlinear_regression(df, subject_col, group_cols, trial_col, value_col, flag= None):
    ...
    ta.plot_fits_summary_avg(df2, shuff_df=shuff, dat_col=value_col, trial_col=trial_col, save_dir=HA.save_dir, use_alpha_pos=False, textsize=20, dotalpha=0.15, flag=flag)
